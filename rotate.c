...
uint32_t rotate(uint32_t num,int bits)
{
    int bi, BITS;
    BITS = 31;
...
// rotateRight function, which performs a right rotation on an unsigned integer by a specified number of bits. It takes an unsigned integer and an amount of rotation as parameters and returns the result of the rotation.
